...
const About = () => {
  return (
    <div className="w-[1440px] h-[2417px] relative bg-white ">
      ...
      <div className="left-[135px] top-[250px] absolute flex-col justify-start items-start gap-10 inline-flex">
        <div className="text-justify text-black text-[54px] font-semibold font-['Inter'] leading-[64px] tracking-[3.24px]">
          Our Story
        </div>
        <div className="flex-col justify-start items-start gap-6 flex">
          <div className="w-[525px] text-black text-base font-normal font-['Poppins'] leading-relaxed">
      ...
      <div className="w-[705px] h-[609px] left-[735px] mt-[143px] absolute bg-[#eb7ea8] rounded-tl rounded-bl">
        <img
          className="w-[837px] h-[609px] left-0 top-0 absolute"
          src="/aboutpgpic.png"
        />
      </div>
      <div className="left-[248px] top-[2164px] absolute justify-center items-center gap-[88px] inline-flex">
      ...
      <div className="left-[135px] top-[1034px] absolute justify-start items-start gap-[30px] inline-flex">
        <div className="w-[270px] h-[230px] relative rounded border border-black/30">
          <div className="left-[50px] top-[30px] absolute flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
              <div className="w-20 h-20 left-0 top-0 absolute">
                <div className="w-20 h-20 left-0 top-0 absolute opacity-30 bg-[#2f2e30] rounded-full" />
                <div className="w-[58px] h-[58px] left-[11px] top-[11px] absolute bg-black rounded-full" />
              ...
              <div className="w-10 h-10 left-[20px] top-[20px] absolute">
                <div className="w-[32.66px] h-[30px] left-[3.66px] top-[5px] absolute"></div>
              </div>
            </div>
        ...
        <div className="w-[270px] h-[230px] relative bg-[#db4444] rounded shadow">
          <div className="left-[35px] top-[32px] absolute flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
              <div className="w-20 h-20 left-0 top-0 absolute">
            ...
            <div className="flex-col justify-start items-center gap-2 flex">
              <div className="text-white text-[32px] font-bold font-['Inter'] leading-[30px] tracking-wider">
                33k
              </div>
        ...
        <div className="w-[270px] h-[230px] relative rounded border border-black/30">
          <div className="h-[170px] left-[40px] top-[30px] absolute flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
              <div className="w-20 h-20 left-0 top-0 absolute">
                <div className="w-20 h-20 left-0 top-0 absolute opacity-30 bg-[#2f2e30] rounded-full" />
                <div className="w-[58px] h-[58px] left-[11px] top-[11px] absolute bg-black rounded-full" />
        ...
        <div className="w-[270px] h-[230px] relative rounded border border-black/30">
          <div className="left-[28px] top-[30px] absolute flex-col justify-start items-center gap-6 inline-flex">
            <div className="w-20 h-20 relative">
              <div className="w-20 h-20 left-0 top-0 absolute">
                <div className="w-20 h-20 left-0 top-0 absolute opacity-30 bg-[#2f2e30] rounded-full" />
                <div className="w-[58px] h-[58px] left-[11px] top-[11px] absolute bg-black rounded-full" />
              ...
              <div className="w-10 h-10 left-[20px] top-[20px] absolute">
                <div className="w-[30.91px] h-[33.38px] left-[4.54px] top-[3.31px] absolute"></div>
              </div>
            </div>
            <div className="flex-col justify-start items-center gap-3 flex">
              <div className="text-black text-[32px] font-bold font-['Inter'] leading-[30px] tracking-wider">
      ...
      <div className="left-[135px] top-[1404px] absolute justify-start items-start gap-[30px] inline-flex">
        <div className="flex-col justify-start items-start gap-8 inline-flex">
          <div className="w-[370px] h-[430px] relative bg-neutral-100 rounded">
            <img
              className="w-[236px] h-[391px] left-[67px] top-[39px] absolute"
              src="/aboutman1.png"
            />
          </div>
          <div className="flex-col justify-start items-start gap-4 flex">
            <div className="flex-col justify-start items-start gap-2 flex">
              <div className="text-black text-[32px] font-medium font-['Inter'] leading-[30px] tracking-wider">
                Tom Cruise
              </div>
              <div className="text-black text-base font-normal font-['Poppins'] leading-normal">
                Founder & Chairman
        ...
        <div className="flex-col justify-start items-start gap-8 inline-flex">
          <div className="w-[370px] h-[430px] relative bg-neutral-100 rounded">
            <img
              className="w-[294px] h-[397px] left-[38px] top-[33px] absolute"
              src="/aboutwoman2.png"
            />
          </div>
          <div className="flex-col justify-start items-start gap-4 flex">
        ...
        <div className="flex-col justify-start items-start gap-8 inline-flex">
          <div className="w-[370px] h-[430px] relative bg-neutral-100 rounded">
            <img
              className="w-[326px] h-[392px] left-[22px] top-[38px] absolute"
              src="/aboutman3.png"
            />
          </div>
          <div className="flex-col justify-start items-start gap-4 flex">
       ...
       <div className="left-[664px] top-[2008px] absolute justify-start items-center gap-3 inline-flex">
    <div className="w-3 h-3 opacity-30 bg-black rounded-full" />
    <div className="w-3 h-3 opacity-30 bg-black rounded-full" />
    <div className="w-4 h-4 relative">
      <div className="w-2.5 h-2.5 left-[3px] top-[3px] absolute bg-[#db4444] rounded-full" />
      <div className="w-4 h-4 left-0 top-0 absolute opacity-30 rounded-full border-2 border-black" />
    </div>
    <div className="w-3 h-3 opacity-30 bg-black rounded-full" />
    <div className="w-3 h-3 opacity-30 bg-black rounded-full" />
  </div> 
