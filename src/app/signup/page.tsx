  ...
  return (
    <div className="h-[781px] justify-start items-center gap-[129px] inline-flex mt-10  mb-24">
      <div className="w-[805px] h-[781px] relative rounded-tr rounded-br">
        <img
          className="w-[919px] h-[706px] left-[8px] top-[75px] mt-[10px] absolute"
          src="/signuppic.png"
        />
      </div>
        ...
        <div className="flex-col justify-start items-center gap-10 flex">
          <div className="flex-col justify-start items-start gap-10 flex">
            <div className="flex-col justify-start items-start gap-2 flex">
              <div className="opacity-40 text-black text-base font-normal font-['Poppins'] leading-normal">
                Name
              </div>
          ...
          <div className="flex-col justify-start items-start gap-4 flex">
            ...
            <div className="flex-col justify-start items-center gap-8 flex">
              ...
              <div className="justify-start items-center gap-4 inline-flex">
                <div className="opacity-70 text-black text-base font-normal font-['Poppins'] leading-normal">
                  Already have account?
                </div>
                <div className="flex-col justify-start items-start gap-1 inline-flex">
                  <Link
                    href="/login"
                    className="opacity-70 text-black text-base font-medium font-['Poppins'] leading-normal"
                  >
                    Login
                  </Link>
